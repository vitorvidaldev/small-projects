...
insert into review(id, rating, description, course_id) values (4002, '1', 'Garbage', 10001);
insert into review(id, rating, description, course_id) values (4003, '4', 'Good', 10003);
